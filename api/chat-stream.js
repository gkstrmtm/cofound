...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const openaiRes = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        model,
        messages: [{ role: "system", content: mergedSystemPrompt }, ...conversationMessages],
        max_tokens: 620,
        temperature: 0.55,
        stream: true
      })
